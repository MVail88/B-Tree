...
/**
 * This Class isn't so much of a test as it is example usage code.
 * It parses each gbk file and doesn't use any of the strings.
 * rather, it only counts how many data blocks are in each file
 */
