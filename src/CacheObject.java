...
/**
 * This class represents a cache object that stores a BTree node and its location
 * The equals method is overridden to compare the location of two cache objects
 * @author ravi
 */
public class CacheObject {
     ...
     * @param cacheNode the cacheNode to set
     */
