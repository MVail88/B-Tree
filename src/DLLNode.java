/**
 * A node for use with a generic double linked list implementation of a data structure.
...
public class DLLNode<E> {
     ...
     * @param element the element to be referenced by the node
     */
    ...
    /**
     * Initializes the links of a node to null and sets the element to the passed one
     * @param element the element to be referenced by the node
     */
     ...
     * @param element the element to be referenced
     */
     ...
     * @param next the node to be referenced
     */
     ...
     * @param previous the node to be referenced
     */
