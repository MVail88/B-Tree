...
/**
 * 
 * Given a query file and a BTree binary file, 
 * builds a Btree from the binary and searches for instances 
 * of each line in the query file and prints out the results
 * 
 * @author ravi
 */
public class GeneBankSearch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // for each query in file, search BTree for query and print TreeObject into a file
    ...
    /**
     * @param args
     * checks the arguments of this program
     * usage: java GeneBankSearch <0/1(without/with Cache)> <btree file> <query file> [<cache size>] [<debug level>]
     */
    private static void checkCommandLineArgs(String[] args) {
        ...
        /* Check if first argument is an integer --> either 0 or 1,
         * if 1, checks that argument length is at least 4
         */
         ...
         * if arguments length == 3, then debug level = false(0) by default.
         * if arguments length == 4, then argument 4 is the debug level and can only be 0.
         * 
        ...
        /* If useCache == true,
         * then argument 3 must be the cache size,
         * and argument 5 if present must be the debug level
         */
        if(useCache == true){
            //if no debug level
    ...
    /**
     * @param stringToCheck The String to be checked if is an integer
